...
//void axpy_cpu( int N, float ALPHA, float *X, int INCX, float *Y, int INCY );	// c2732 에러 [6/28/2018 jobs]
//void copy_cpu( int N, float *X, int INCX, float *Y, int INCY );	// c2732 에러 [6/28/2018 jobs]
//void scal_cpu( int N, float ALPHA, float *X, int INCX );	// c2732 에러 [6/28/2018 jobs]
