...
// X 배열의 모든 값에 ALPHA 를 각각 곱하여 Y 배열 각각의 값에 더한다
void axpy_cpu( int N, float ALPHA, float *X, int INCX, float *Y, int INCY );
void copy_cpu( int N, float *X, int INCX, float *Y, int INCY );
void scal_cpu( int N, float ALPHA, float *X, int INCX );	// X 배열의 모든값에 ALPHA 를 각각 곱한다
...
// 소프트맥스 출력값 계산
void softmax( float *input, int GaeSu, float GaJungGab, float *output );

#ifdef GPU
#include "cuda.h"

void axpy_ongpu( int N, float ALPHA, float * X, int INCX, float * Y, int INCY );	// X 값에 ALPHA 를 곱해 Y 값을 구한다
void axpy_ongpu_offset( int N, float ALPHA, float * X, int OFFX, int INCX, float * Y, int OFFY, int INCY );
void copy_ongpu( int N, float * X, int INCX, float * Y, int INCY );
void copy_ongpu_offset( int N, float * X, int OFFX, int INCX, float * Y, int OFFY, int INCY );
void scal_ongpu( int N, float ALPHA, float * X, int INCX );	// X 값에 ALPHA 값을 곱한다
...
void fill_ongpu( int N, float ALPHA, float * X, int INCX );	// X 의 모든 값을 ALPHA 값으로 설정한다
