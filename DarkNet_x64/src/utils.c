...
void del_arg( int argc, char **argv, int SaegIn )
{
	int i;

	for ( i=SaegIn; i<argc-1; ++i )
		argv[i] = argv[i+1];
...
int find_arg( int argc, char* argv[], char *GaRilGab )
{
	int i;
...
int find_int_arg( int argc, char **argv, char *GaRilGab, int def )
{
	int i;
...
float find_float_arg( int argc, char **argv, char *GaRilGab, float def )
{
	int i;
...
char *find_char_arg( int argc, char **argv, char *GaRilGab, char *def )
{
	int i;
